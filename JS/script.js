      ...
      $.each(responseData, function (i, v) {
        ...
        <div class="song-title">
            ...
            if(cnt1==5){
               ...
               $(`<div class="carousel-item active"><div id="Podcasts-section">${podcasts}</div></div>`).appendTo('.podcasts');
               podcasts='';
          
              }
  
              else if( cnt1 % 5 == 0 &&  cnt1 != 5){
              $(`<div class="carousel-item "><div id="Podcasts-section">${podcasts}</div></div>`).appendTo('.podcasts');
      ...
      $.each(responseData, function (i, v) {
        ...
        <div class="song-title">
            ...
            if(newReleaseCount==5){
              ...
              $(`<div class="carousel-item "><div id="newRelease-section">${newRelease}</div></div>`).appendTo('.carousel-releases');
        ...
        $.each(responseData, function (i, v) {
          ...
          <div class="song-title">
              ...
              if(counter==5){
                //console.log("inside new release"+newRelease);
                console.log("inside if")
                 $(`<div class="carousel-item active"><div id="display-for-song-playlist">${song}</div></div>`).appendTo('.song-carousel')
                 song='';
                }
    
                else if(counter % 5 == 0 && counter != 5){
                $(`<div class="carousel-item "><div id="display-for-song-playlist">${song}</div></div>`).appendTo('.song-carousel');
